...
const WorkSiteDetail: React.FC = () => {
    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: theme.background.primary }]}>
        <View style={styles.loadingContainer}>
          <Text style={[styles.loadingText, { color: theme.text.primary }]}>読み込み中...</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background.primary }]}>
      ...
      >
        {/* 基本情報カード */}
        <View style={[styles.card, { backgroundColor: theme.background.surface }]}>
          <View style={styles.cardHeader}>
            <Text style={[styles.cardTitle, { color: theme.text.primary }]}>基本情報</Text>
          ...
          <View style={styles.infoRows}>
            <View style={styles.infoRow}>
              <Text style={[styles.infoLabel, { color: theme.text.primary }]}>現場名</Text>
              <Text style={[styles.infoValue, { color: theme.text.primary }]}>{workSite.name}</Text>
            </View>

            <View style={styles.infoRow}>
              <Text style={[styles.infoLabel, { color: theme.text.primary }]}>工事種別</Text>
            ...
            <TouchableOpacity style={styles.infoRow} onPress={openInMaps}>
              <Text style={[styles.infoLabel, { color: theme.text.primary }]}>住所</Text>
              <Text style={[styles.infoValue, styles.linkText, { color: Colors.accent.DEFAULT }]}>
                {workSite.address}
              </Text>
            </TouchableOpacity>
            ...
            {workSite.client_name && (
              <View style={styles.infoRow}>
                <Text style={[styles.infoLabel, { color: theme.text.primary }]}>発注者</Text>
                <Text style={[styles.infoValue, { color: theme.text.primary }]}>{workSite.client_name}</Text>
              </View>
            )}
            ...
            {workSite.client_contact && (
              ...
              >
                <Text style={[styles.infoLabel, { color: theme.text.primary }]}>連絡先</Text>
                <Text style={[styles.infoValue, styles.linkText, { color: Colors.accent.DEFAULT }]}>
                  {workSite.client_contact}
                </Text>
              </TouchableOpacity>
            ...
            {workSite.client_email && (
              ...
              >
                <Text style={[styles.infoLabel, { color: theme.text.primary }]}>メール</Text>
                <Text style={[styles.infoValue, styles.linkText, { color: Colors.accent.DEFAULT }]}>
                  {workSite.client_email}
                </Text>
              </TouchableOpacity>
            ...
            {(workSite.construction_start || workSite.construction_end) && (
              <View style={styles.infoRow}>
                <Text style={[styles.infoLabel, { color: theme.text.primary }]}>工期</Text>
                <Text style={[styles.infoValue, { color: theme.text.primary }]}>
            ...
            {workSite.budget && (
              <View style={styles.infoRow}>
                <Text style={[styles.infoLabel, { color: theme.text.primary }]}>予算</Text>
                <Text style={[styles.infoValue, { color: theme.text.primary }]}>
        ...
        <View style={[styles.card, { backgroundColor: theme.background.surface }]}>
          <View style={styles.cardHeader}>
            <Text style={[styles.cardTitle, { color: theme.text.primary }]}>写真・資料</Text>
            <TouchableOpacity
              style={styles.viewAllButton}
              onPress={() => router.push(`/work-sites/gallery/${id}`)}
            >
              <Text style={[styles.viewAllText, { color: Colors.accent.DEFAULT }]}>すべて表示</Text>
          ...
          <View style={styles.attachmentSummary}>
            <View style={styles.attachmentItem}>
              <Ionicons name="camera" size={20} color={theme.text.primary} />
              <Text style={[styles.attachmentLabel, { color: theme.text.primary }]}>進捗写真</Text>
              <Text style={[styles.attachmentCount, { color: Colors.accent.DEFAULT }]}>
            ...
            <View style={styles.attachmentItem}>
              ...
              <Text style={[styles.attachmentLabel, { color: theme.text.primary }]}>図面</Text>
              <Text style={[styles.attachmentCount, { color: Colors.accent.DEFAULT }]}>
            ...
            <View style={styles.attachmentItem}>
              <Ionicons name="folder" size={20} color={theme.text.primary} />
              <Text style={[styles.attachmentLabel, { color: theme.text.primary }]}>書類</Text>
              <Text style={[styles.attachmentCount, { color: Colors.accent.DEFAULT }]}>
            ...
            <View style={styles.attachmentItem}>
              ...
              <Text style={[styles.attachmentLabel, { color: theme.text.primary }]}>安全報告</Text>
              <Text style={[styles.attachmentCount, { color: Colors.accent.DEFAULT }]}>
          ...
          <TouchableOpacity
            style={[styles.uploadButton, { backgroundColor: Colors.accent.DEFAULT }]}
            onPress={() => {
              // TODO: ファイルアップロード処理
        ...
        <View style={[styles.card, { backgroundColor: theme.background.surface }]}>
          <View style={styles.cardHeader}>
            <Text style={[styles.cardTitle, { color: theme.text.primary }]}>メモ</Text>
            <TouchableOpacity style={styles.addNoteButton}>
              <Ionicons name="add" size={20} color={Colors.accent.DEFAULT} />
            </TouchableOpacity>
          </View>
          ...
          {notes.length > 0 ? (
            <View style={styles.notesList}>
              {notes.slice(0, 3).map((note) => (
                <View key={note.id} style={styles.noteItem}>
                  <View style={styles.noteHeader}>
                    <Text style={[styles.noteContent, { color: theme.text.primary }]} numberOfLines={2}>
                      {note.content}
                    </Text>
                    {note.is_important && (
                  ...
                  <Text style={[styles.noteDate, { color: theme.text.primary + '80' }]}>
              ...
              {notes.length > 3 && (
                <TouchableOpacity style={styles.moreNotesButton}>
                  <Text style={[styles.moreNotesText, { color: Colors.accent.DEFAULT }]}>
            ...
            <View style={styles.emptyNotes}>
              <Ionicons name="document-text-outline" size={32} color={theme.text.primary + '50'} />
              <Text style={[styles.emptyText, { color: theme.text.primary + '80' }]}>
                メモがまだありません
              </Text>
            </View>
          )}
        ...
        {(workSite.notes || workSite.safety_requirements || workSite.special_instructions || workSite.access_instructions) && (
          <View style={[styles.card, { backgroundColor: theme.background.surface }]}>
            <Text style={[styles.cardTitle, { color: theme.text.primary }]}>備考・特記事項</Text>

            {workSite.notes && (
              <View style={styles.remarksSection}>
                <Text style={[styles.remarksLabel, { color: theme.text.primary }]}>一般備考</Text>
                <Text style={[styles.remarksText, { color: theme.text.primary }]}>{workSite.notes}</Text>
              </View>
            )}

            {workSite.safety_requirements && (
              <View style={styles.remarksSection}>
                <Text style={[styles.remarksLabel, { color: theme.text.primary }]}>安全要求事項</Text>
                <Text style={[styles.remarksText, { color: theme.text.primary }]}>{workSite.safety_requirements}</Text>
              </View>
            )}

            {workSite.special_instructions && (
              <View style={styles.remarksSection}>
                <Text style={[styles.remarksLabel, { color: theme.text.primary }]}>特別指示事項</Text>
                <Text style={[styles.remarksText, { color: theme.text.primary }]}>{workSite.special_instructions}</Text>
              </View>
            )}

            {workSite.access_instructions && (
              <View style={styles.remarksSection}>
                <Text style={[styles.remarksLabel, { color: theme.text.primary }]}>アクセス方法</Text>
                <Text style={[styles.remarksText, { color: theme.text.primary }]}>{workSite.access_instructions}</Text>
              </View>
            )}
          </View>
        )}
